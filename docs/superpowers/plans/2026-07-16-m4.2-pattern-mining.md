...
- [ ] **Step 2: Run it against the live warehouse (read-only)**
...
- [ ] **Step 3: Verify it is genuinely read-only**
...
- [ ] **Step 1: Run the mine and capture the real output**
...
- [ ] **Step 2: Write `docs/emergence-patterns-findings.md`**
...
- [ ] **Step 3: Add the pointer header to the backlog doc**
...
- [ ] **Step 1: Check whether it still runs**
...
- [ ] **Step 2: Confirm the harness is still read-only and the ledger untouched**
...
- [ ] **Step 3: Confirm mine-rules stays offline-pure**
