...
**Spec:** `docs/superpowers/specs/2026-07-16-m4.2-pattern-mining-design.md`
...
**Files:**
- Create: `docs/emergence-patterns-findings.md`
- Modify: `docs/emergence-patterns-m4-backlog.md` (add a pointer header)
...
- [x] **Step 2: Write `docs/emergence-patterns-findings.md`**

Structure it exactly like the project's existing analysis docs (`docs/precursor-patterns.md` is the model):
...
Insert at the top of `docs/emergence-patterns-m4-backlog.md`, immediately after the `# Emergence Patterns` heading:
...
```bash
git add docs/emergence-patterns-findings.md docs/emergence-patterns-m4-backlog.md
...
docs/precursor-patterns.md - was sitting in gitignored tmp/, one
...
> behind `docs/precursor-patterns.md`) no longer runs against the current
...
node scripts/mine-patterns.js  # M4.2: replay the 8 pre-registered pattern hypotheses over the
                               ...
                               # real-price EV). Read-only. See docs/emergence-patterns-findings.md
```
...
See `docs/emergence-patterns-findings.md` for results and
`docs/superpowers/specs/2026-07-16-m4.2-pattern-mining-design.md` for scope.
