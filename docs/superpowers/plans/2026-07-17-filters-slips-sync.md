...
**Goal:** Ship the approved spec `docs/superpowers/specs/2026-07-17-filters-slips-sync-design.md`: persist the advanced-filter tree so it rides the existing prefs sync, add a throttled tab-focus sync, and verify slips (already synced) end to end.
