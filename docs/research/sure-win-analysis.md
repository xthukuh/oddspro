...
> positive-EV.** See `docs/research/fair-comparison-and-false-positives.md` and
> `docs/research/data-independence.md`. The rest of this study (no +EV sure-win; the
...
- The safest realistic use is still the **Safety Net Protocol**
  (`docs/guides/safety-net-protocol.md`): flat 1–2% stakes, 2–3 leg slips, never chase.
