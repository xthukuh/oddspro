...
triage: `docs/dev/specs/2026-07-16-m4.2-pattern-mining-design.md`.*
...
loser** (`docs/research/precursor-patterns.md`) precisely because it prices around there.
...
(see `docs/research/m4.2b-booster-validation-and-value-edge.md` for the mechanistic
...
`docs/research/precursor-patterns.md` produced **three OOS-validated boosters that were
...
proven anti-correlated with live ROI once (`docs/research/sure-win-analysis.md`).

## Sample-size caveats — read before acting

- **14 tip-days, and effectively 9 + 5 split by a policy change.** The
  beat-the-book C3 bar is **≥30 independent match-days**; `docs/research/beat-the-book-roadmap.md`
