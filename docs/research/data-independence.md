...
lives in `docs/research/data-integrity-and-signal-audit.md` (correctness + signal
decomposition) and `docs/research/fair-comparison-and-false-positives.md` (the fair,
...
- Evidence: `docs/research/data-integrity-and-signal-audit.md`,
  `docs/research/fair-comparison-and-false-positives.md`.
- The (currently NO-GO) path to an independent edge:
  `docs/research/beat-the-book-roadmap.md`.
- Superseded "+EV" framing corrected in `docs/research/sure-win-analysis.md` and
