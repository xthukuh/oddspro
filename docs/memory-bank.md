...
- Automation (2026-07-03): Windows Task Scheduler task `oddspro-pipeline` runs `scripts/pipeline-task.cmd` daily 08:00 → `logs/pipeline.log`; smoke-tested clean. Prediction phase scoped (not started): `docs/prediction-scoping.md`.
