...
**Spec:** `docs/dev/specs/2026-07-09-ios-tablet-ui-redesign-design.md` (read it first — full token table, no-regression inventory, icon set).
...
- The v3 prototype (`docs/dev/specs/…-design.md` references project `719b928e-470e-4aab-af7d-0c2759f36d5e`) is the visual reference for spacing/colors when a detail is ambiguous.
